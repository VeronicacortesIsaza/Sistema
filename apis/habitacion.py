...
async def crear_habitacion(habitacion_data: HabitacionCreate, db: Session = Depends(get_db)):
...
async def actualizar_habitacion( 
    id_habitacion: UUID, habitacion_data: HabitacionUpdate, db: Session = Depends(get_db)
):
